...
@fModel(registryname = "zmp:models/vehicles/4x4_samu")
public class Model4x4Samu extends VehicleModel {
    ...
    public Model4x4Samu(){
        ...
        body[100].rotationAngleZ = Statics.toDegrees(-0.6981317F);
